...
.get(async (req, res) => {
    ...
    if(user.username === profile_user.username){
        ...
        res.render('userhome', {layout: 'userProfiles', newUser: profile_user.username, userTeams: teamData});
    }
    else{
        res.render('userProfile', {layout: 'userProfiles', newUser: profile_user.username, userTeams: teamData});
